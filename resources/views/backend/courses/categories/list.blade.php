@extends('backend.layouts.app', ['activePage' => 'courses', 'title' => 'All Course Categories', 'navName' => 'coursecategories', 'activeButton' => 'catalogue'])
    ...
    <div class="page-header">
        <div class="row align-items-center mb-3">
            ...
            <div class="col-sm-auto">
                <a class="btn btn-primary" href="{{ route('backend.courses.categories.create') }}">Add Category</a>
            </div>
            <!-- End Col -->
        </div>
        <!-- End Row -->
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a class="btn btn-dark btn-sm"
                                                    href="{{ route('backend.courses.categories.edit', $category->id) }}">Edit</a>
                                                <!-- Button Group -->
                                                <div class="btn-group">
                                                    <button type="button"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end mt-1"
                                                        ...
                                                        <a onclick="return confirm('Are you sure you want to delete this category?')" class="dropdown-item text-danger" href="{{ route('backend.courses.categories.delete', $category->id) }}">Delete</a>
                                                    </div>
                                                </div>
                                                <!-- End Unfold -->
                                            </div>
